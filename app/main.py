...
with row2[2]:
    avg_dpd_per_delinquency = st.number_input('Avg DPD',min_value=0,step=1,value=20)

with row3[0]:
    delinquency_ratio = st.number_input('Delinquency Ratio', min_value=0, step=1,max_value=100,value=30)
with row3[1]:
